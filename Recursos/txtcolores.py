...
Funciones:
    - strclr: Devuelve el texto indicado con el color de texto, fondo y estilo
    indicado.
    - strclr_random: Devuelve el texto indicado con un color de texto
    aleatorio.
"""
import random
...
def strclr(
    texto,
    color_texto: str | int = None,
    color_fondo: str | int = None,
    estilo: str | int = None,
) -> str:
    """
    función que devuelve el texto indicado con el color de texto, fondo y
    estilo indicado.

    args:
        - texto: texto a devolver con el color indicado

        - color_texto: color de texto a utilizar. Puede ser un string con el
        nombre del color o un entero con el número de color.

        - color_fondo: color de fondo a utilizar. Puede ser un string con el
        nombre del color o un entero con el número de color.

        - estilo: estilo a utilizar. Puede ser un string con el nombre del
        stilo o un entero con el número de estilo.

    @return:
        - devuelve el texto indicado con el color de texto, fondo y estilo
        indicado.
...
def strclr_random(texto: str, cantidad_colores: int = 250) -> str:
    """
    Devuelve el texto indicado con una letra de cada color con cantidad de
    colores random.
    ...
    @return:
        - devuelve el texto indicado con una letra de cada color con cantidad
        de colores random.
