"""
Crear un diccionario en el cual las llaves sean números enteros y los valores
sean sus cuadrados. Haz esto para números del 1 al n.
"""
...
def crear_tupla(cantidad: int) -> list[int]:
